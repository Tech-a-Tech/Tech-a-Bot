...
var userAgent = "Mozilla/5.0 (Windows NT 6.3; Win64; x64) Gecko/20100101 Firefox/53.0"
...
function picture(q, nsfw = false) {
  return req(`https://www.google.com/search?ie=ISO-8859-1&hl=en&source=hp&tbm=isch&gbv=1&gs_l=img&q=${q}&safe=${nsfw ? "disabled" : "active"}`)
...
async function search(q, nsfw) {
  ...
  var res = await request.get("https://google.com/search")
    .query(parameters)
    .set(h);
  let card;
  let results = []
